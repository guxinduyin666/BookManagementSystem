			...
			<el-table :data="users" highlight-current-row v-loading="loading" style="width: 100%;">
				...
				<el-table-column label="操作" width="150">
					<template slot-scope="scope">
						<el-button size="small" :disabled="isDisabled" @click="showAddDialog(scope.$index,scope.row)">编辑</el-button>
						<el-button type="danger" :disabled="isDisabled" @click="deleteUser(scope.$index,scope.row)" size="small">删除</el-button>
					</template>
				</el-table-column>
			</el-table>
			<!--新增界面-->
				...
				<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
					...
					<el-form-item label="角色" prop="role">
						<el-radio-group v-model="addForm.role">
							<el-radio :label="0" disabled>系统管理员</el-radio>
